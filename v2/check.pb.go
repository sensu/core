...
type Check struct {
	...
	// the check status.
	OutputMetricThresholds []*MetricThreshold    `protobuf:"bytes,48,rep,name=output_metric_thresholds,json=outputMetricThresholds,proto3" json:"output_metric_thresholds,omitempty" yaml: "output_metric_thresholds,omitempty"`
	Subdues                []*TimeWindowRepeated `protobuf:"bytes,49,rep,name=subdues,proto3" json:"subdues,omitempty"`
	// ExtendedAttributes store serialized arbitrary JSON-encoded data
...
var fileDescriptor_d70eac2f90fbef24 = []byte{
	...
	,
}
...
func NewPopulatedCheckConfig(r randyCheck, easy bool) *CheckConfig {
	...
	if r.Intn(5) != 0 {
		v22 := r.Intn(5)
		this.FallbackPipeline = make([]*ResourceReference, v22)
		for i := 0; i < v22; i++ {
	...
	if r.Intn(5) != 0 {
		v23 := r.Intn(5)
		this.OutputMetricThresholds = make([]*MetricThreshold, v23)
		for i := 0; i < v23; i++ {
	...
	if r.Intn(5) != 0 {
		v24 := r.Intn(5)
		this.Subdues = make([]*TimeWindowRepeated, v24)
		for i := 0; i < v24; i++ {
...
func NewPopulatedCheck(r randyCheck, easy bool) *Check {
	...
	if r.Intn(5) != 0 {
		v40 := r.Intn(5)
		this.FallbackPipeline = make([]*ResourceReference, v40)
		for i := 0; i < v40; i++ {
			this.FallbackPipeline[i] = NewPopulatedResourceReference(r, easy)
		}
	}
	if r.Intn(5) != 0 {
		v41 := r.Intn(5)
		this.OutputMetricThresholds = make([]*MetricThreshold, v41)
		for i := 0; i < v41; i++ {
			this.OutputMetricThresholds[i] = NewPopulatedMetricThreshold(r, easy)
		}
	}
	if r.Intn(5) != 0 {
		v42 := r.Intn(5)
		this.Subdues = make([]*TimeWindowRepeated, v42)
		for i := 0; i < v42; i++ {
			this.Subdues[i] = NewPopulatedTimeWindowRepeated(r, easy)
		}
	}
