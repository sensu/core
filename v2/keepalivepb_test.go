...
func TestKeepaliveRecordProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, false)
...
func TestKeepaliveRecordMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, false)
	size := p.Size()
...
func TestKeepaliveRecordJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, true)
...
func TestKeepaliveRecordProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, true)
...
func TestKeepaliveRecordProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, true)
...
func TestKeepaliveRecordFace(t *testing.T) {
...
func TestKeepaliveRecordSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedKeepaliveRecord(popr, true)
